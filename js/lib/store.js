...
const orderColumns = {
  ...
  // Discord-Bot
  bot_settings: ['updated_at', { ascending: false }],
  bot_status: ['last_heartbeat', { ascending: false }],
  bot_logs: ['created_at', { ascending: false }],
  bot_actions: ['created_at', { ascending: false }],

  bot_moderation_cases: ['created_at', { ascending: false }],
  bot_moderation_case_revisions: ['created_at', { ascending: false }],

  bot_tickets: ['created_at', { ascending: false }],
  bot_ticket_transcripts: ['created_at', { ascending: false }],

  bot_levels: ['updated_at', { ascending: false }],

  bot_channel_lock_snapshots: ['locked_at', { ascending: false }],

  bot_duty_shifts: ['started_at', { ascending: false }],
  bot_admin_calls: ['created_at', { ascending: false }],
  bot_ban_requests: ['created_at', { ascending: false }],

  bot_roblox_profiles: ['updated_at', { ascending: false }],
  bot_roblox_name_history: ['changed_at', { ascending: false }],
  bot_user_files: ['updated_at', { ascending: false }],

  bot_session_requests: ['starts_at', { ascending: true }],
  bot_session_rsvps: ['updated_at', { ascending: false }],

  bot_giveaways: ['created_at', { ascending: false }],
  bot_giveaway_entries: ['joined_at', { ascending: false }],

  bot_partner_posts: ['created_at', { ascending: false }],
  bot_creator_proofs: ['submitted_at', { ascending: false }],

  bot_activity_daily: ['activity_date', { ascending: false }],
  bot_active_member_suggestions: ['created_at', { ascending: false }],

  bot_rp_rank_assignments: ['assigned_at', { ascending: false }],

  bot_structure_backups: ['created_at', { ascending: false }],
  bot_security_events: ['created_at', { ascending: false }],
  bot_invite_snapshots: ['updated_at', { ascending: false }],
